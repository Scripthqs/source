...
JSONP(JSOP with padding)，是一个非官方的跨域解决方案，只支持get请求。

在网页中，一些标签自带跨越功能，比如，img link iframe script，jsonp就是利用script标签的跨域功能来发送请求。

CORS跨域资源共享，是官方的跨域解决方案，它的特点是不需要在客户端做任何特殊的操作，完全在服务器中进行处理，支持get和post请求。
