...
4. 端口号：服务器中的端口号就像是生活中的门牌号一样，通过门牌号准确的将邮件送到手里，一台电脑，可以运行N个web服务，每个web服务都对应一个唯一的端口号，客户端发来的网络请求，通过端口号，可以准确的交给对应的web服务进行处理。服务器的端口号是不可以重复的，必须是独一无二的，http服务默认端口号是80。
